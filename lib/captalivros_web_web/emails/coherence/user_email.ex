...
defmodule CaptalivrosWebWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: CaptalivrosWebWeb.Coherence.EmailView, layout: {CaptalivrosWebWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
